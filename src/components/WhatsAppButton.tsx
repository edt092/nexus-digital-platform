export default function WhatsAppButton() {
  return (
    <a
      href="https://wa.me/593987098437"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Contactar por WhatsApp"
      className="fixed bottom-6 right-6 z-50 size-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform animate-[wa-pulse_3s_ease-in-out_infinite]"
    >
      <svg
        viewBox="0 0 32 32"
        fill="white"
